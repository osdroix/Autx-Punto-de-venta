 ...
 * @author osdroix
 */
@WebServlet(name = "GuardarAdm", urlPatterns = {"/GuardarAdm"})
public class GuardarAdm extends HttpServlet {
            ...
            CRUD u=new CRUD();  
                ...
                if (u.validarEmple(usu) || u.validarregistro(usu) ) {
                 ...
                 response.sendRedirect("/aut/avisos/Dashboard0.jsp?in=correo invalido&error=Correo no valido&img=/aut/img/409.gif");
                  ...
                  response.sendRedirect("/aut/avisos/Dashboard0.jsp?in=Registro&error=Validado&id=3&img=/aut/img/auto2.gif");
