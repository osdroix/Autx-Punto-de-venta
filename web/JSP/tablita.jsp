    ...
    <html>
        ...
        <div class="muro">
                    <table class="table table-dark">   
                        ...
                        us=CRUD.getMostarPRODUCTOCONPROVEEDOR(parse);
                        for(Producto o:us){
                                out.println("<tr><td>"
                                    + "<h4 align='center'><img src='"+o.getDescripcion()+"' width='200' height='200'><br>"+o.getNombre()+"</h4></td><td>"
                                    + "<h3>Proveedor: <a class='btn btn-link' href='/aut/JSP/producto_prove.jsp?id_prove="+o.getNom_empre_prove()+"'>"+o.getNom_empre_prove()+"</a><br>"
                                    + "<h3> Caducidad:"+o.getFecha()+"<br>"
                                    + "Cantidad Kg o Producto:  "+o.getNum_cantidad()+"<br>"
                                    + "Precio:<br></h3>"
                                    + "<h1 class='azul' align='center'>"+o.getPrecio()+"MXN</h1></td><td>"
                                    + "<a class='btn btn-danger' href='/aut/JSP/tablita.jsp?pollo="+o.getId_incremet()+"&nom="+o.getNombre()+"&ID="+o.getId_tipo()+"'>Seleccionar</a></td><td>"
