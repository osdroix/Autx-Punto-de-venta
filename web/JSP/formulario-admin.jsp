        ...
        <div  class="Muro-registro-emple">
            <div class="party">
             <div class="submuro-registro-emple">
                    <h3 >Registro </h3><hr>
                    <form action="/aut/GuardarAdm" method="post">
                                        <input type="hidden" value="3" name="id"/>
                                        <input type="hidden" value="3" name="base"/>
                                        <!-- Nombre -->
                                    ...
                                    <center><a type="submit" class="btn btn-warning" href="/aut/Super-Admin/administradores.jsp" >Regresar</a></center>
                </div>
                                <div class="submuro-registro-emple">
...
<script>
    $(document).ready(function () {
        const form = $('form[action="/aut/GuardarAdm"]');
