...
<body  class="l">
    ...
    <div class="muro">
                <table class="table table-dark">
                    ...
                    us=CRUD.getUsu();
                    out.println("<tr><td><h4 class='hy'>Datos Usuarios"
                                  + "<td><h4 class='hy'>Selecionar para dar de baja</tr>");
                    for(usuarios o:us){
                          
                          out.println("<tr><td>"
                                + "<h5>Usuario:   "+o.getUsuario()+"<br>"
                                + "Correo:  "+o.getCorreo()+"<br></td><td> "
                                + "<a href='/aut/Super-Admin/"
                                + "usuarios.jsp?ID2="+o.getRela()+""
                                + "&ID="+o.getId()+"&NUM="+58+"&nom="+o.getNombre()+"&contra="+o.getContra()+"&corr="+o.getCorreo()+"'><img  alt='Responsive image'src='/aut/img/basura1.png'width='80' height='80'/></a></td><td></h5>"
                                + "</tr>");
