	...
	<h3  class="hy" >
            Ventas
               <div class="p">
                ...
                <div class="p">
                    <A  class="btn btn-primary" href="/aut/Administrador/reportes.jsp" >
                        Ventas Fiscas
                    </A>
                 </div>
                <div class="p">
              ...
              <%         
                  ...
                  if(p == null & pp == null){%>
                <br><center><h1>Reporte de Ventas Online</h1></center><hr>
                <div class="party">
                    <div class="panel">
                        <table class="table">
                         <thead class="thead-dark">
                            ...
                            us = CRUD.getMostartiquetqcarro(fecha.toString());
                            for (tiquet o : us) {
                            %>
                            <tr>
                    ...
                    <div class="panel">
                        <table class="table">
                         <thead class="thead-dark">
                            ...
                            <% 
                            ArrayList<tiquet> us = new ArrayList();
                            us = CRUD.getMostartiquetqcarro(p);
                            for (tiquet o : us) {
                            %>
                            <tr>
                                <td><%= o.getId_tiquet() %></td>
              ...
              <%
                  ...
                  System.out.print("Hola esta es tu fecha buscada"+p);
              %>
                <br><center><h1>Reporte de Ventas Online Mes</h1></center><hr>
                <div class="party">
                    <div class="panel">
                        <table class="table">
                         <thead class="thead-dark">
                            ...
                            <% 
                            ArrayList<tiquet> us = new ArrayList();
                            us = CRUD.getMostartiquetqPorMescarro(pp);
                            for (tiquet o : us) {
                            %>
                            <tr>
                                <td><%= o.getId_tiquet() %></td>
...
<div class="overlay" id="overlay">
    <div class="popup" id="popup">
        ...
        <form id="searchForm" action="vo.jsp" method="post">
            <!-- Primer select para días -->
            <select class="form-control select-options" type="text" name="p" id="selectDia">
                <% 
                    try {
                        Connection c = Conexion.getConnection();
                        String x = "SELECT DISTINCT Fecha_tiquet FROM tiquet_carrito";
            ...
            <select class="form-control select-options" type="text" name="pp" id="selectMes" style="display: none;">
                <% 
                    try {
                        ...
                        String xp = "SELECT DISTINCT MONTH(Fecha_tiquet) AS mes_numero, MONTHNAME(Fecha_tiquet) AS nombre_mes FROM tiquet_carrito";
