                ...
                <p align="center"><div class="row" >
                    ...
                    for(usuarios o:us){%>
                        ...
                        <div align="center">
                            ...
                            <h6> Correo: <%out.println(o.getCorreo());%></h6>
                             <div align="right"> 
                                         <%
                                         out.println("<a class='btn btn-danger' href='/aut/Administrador/"
                                + "usuarios.jsp?ID2="+o.getRela()+""
                                + "&ID="+o.getId()+"&NUM="+1+"&nom="+o.getNombre()+"&contra="+o.getContra()+"&corr="+o.getCorreo()+"'>Seleccionar</a></h5>");%>
                                 </div> </div>
