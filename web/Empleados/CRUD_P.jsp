    ...
    <body  class="l">
        <div class="Productos1">
            <h1 class="hy"align="center">Lista de productos<hr>
              <% 
                out.println(""
                + "<a href='/aut/Empleados/tablita.jsp?ID="+1+"'><img id='centro' alt='Responsive image'src='/aut/img/crema.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+2+"' ><img  id='centro' alt='Responsive image'src='/aut/img/ver.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+3+"' ><img id='centro' alt='Responsive image'src='/aut/img/chetoss.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+4+"' ><img id='centro' alt='Responsive image'src='/aut/img/chile.jpg'></a><hr>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+5+"' ><img id='centro' alt='Responsive image'src='/aut/img/farma.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+6+"'><img id='centro' alt='Responsive image'src='/aut/img/helado.webp'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+7+"' ><img id='centro' alt='Responsive image'src='/aut/img/pan.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+8+"' ><img id='centro' alt='Responsive image'src='/aut/img/limpe.jpg'></a><hr>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+9+"' ><img id='centro' alt='Responsive image'src='/aut/img/croqueta.webp'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+10+"' ><img id='centro' alt='Responsive image'src='/aut/img/semi.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+11+"' ><img id='centro' alt='Responsive image'src='/aut/img/refre.jpg'></a>"
                +"<a href='/aut/Empleados/tablita.jsp?ID="+12+"' ><img id='centro' alt='Responsive image'src='/aut/img/mas.png'></a>");
              %> 
        </h1></div>
