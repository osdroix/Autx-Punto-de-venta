...
<body class="bodys"onLoad="redireccionar()" oncontextmenu="return false" >
  ...
  function redireccionar() {
    setTimeout("location.href='/aut/Clientes/menu.jsp'", 18000000);
  }
  </script>
  <div class="main">
    <br>
    <h1 class="hy"align="center">
      Menú<br>
        ...
        <h4  align="center" class="hy">Cliente
      <hr>
    ...
    <h3 align="center" class="hy"><%out.println(u.getUsuario());%></h3> <hr>
      <h4 class="hy" align="center">
        ...
        <a class="hy" href = "/aut/Clientes/Tiquet-vista.jsp" target="der" > Mis Compras</a><br>
        <a class="hy" href = "/aut/Controlador?accion=home" target="der">Carrito</a><br>
        <a class="hy" href = "/aut/Clientes/CRUD_P.jsp" target="der" > Producto</a><br>

        <% 
        out.println("<a class='hy' TARGET='_top' href='/aut/Clientes/editar.jsp?Usu="+u.getUsuario()+"&Id="+u.getRela()+"'>Perfil</a>");
         %>
        <br><hr>
      </h4>
      <h6 align="center" class="hy">
          
      <A  class="btn btn-success btn-block" href="/aut/Controlador?accion=cerrars" target="_top">Cerrar sesión</A><br>
    By Aut-X</h6>
