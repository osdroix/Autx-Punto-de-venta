	...
	<h3  class="hy" >
		Administradores
               <div class="p">
                ...
                <div class="p">
                   <A  class="btn btn-success btn-block" href="/aut/JSP/formulario-admin.jsp" target="_top">
                     <img src='/aut/img/mas.png'width='40' height='40'/>Agregar
                   </A>
                 </div>
        </h3></div>
                ...
                <table class="table table-dark">
                    ...
                    for(empleado o:us){
                          ...
                          out.println("<tr><td>"
                                ...
                                + "<a href='/aut/Super-Admin/administradores.jsp?ID="+o.getUsu()+"&NUM="+5+"&nom="+o.getNombre()+"&contra="+o.getContra()+"&corr="+o.getCorreo()+"'><img  alt='Responsive image'src='/aut/img/basura1.png'width='80' height='80'/></a></td><td>"
                                + "</tr>");
