    ...
    <body>
         ...
         <div class="container mt-2">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand">Salida de producto</a>
                ...
                <li class="nav-item">
                    <a class="nav-link disabled" href="Controlador?accion=Carrito-empleado">
                        <i >(<label style="color: orange"> ${contador} </label>)</i>Productos agregados</a>
                </li>
                ...
                <div class="col-sm-4">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <a href="Controlador?accion=GenerarCompra&producto=${carrito}&<% out.println("id="+u.getUsu()+"");%>&total=${total}" class="btn btn-danger btn-block">Generar Compra</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="JS/funciones-empleado.js" type="text/javascript"></script>
                         <script>
