...
<body class="l">
	...
	<h3  class="hy" >
		Tiquet 
                <div class="p">
                   <A  class="btn btn-success btn-block" href="/aut/Administrador/tiquet-carro.jsp" >
                    <img src='/aut/img/2.png'width='30' height='30'/> Tíquet-Carrito
                   </A>
                 </div>
                <div class="p">
                ...
                <div class="p">
                     <form action="/aut/Administrador/tiquet.jsp" method="POST">
                     <p class="party"> <select class="btn btn-success"  name="emple">
                                <%
                        ...
                        <button type="submit" class="btn btn-link">
                            ...
                            <img  alt="Responsive image"src="/aut/img/lup.png"width="35" height="35"/>
                        </button>
                    </form>
                </div>
        </h3></div>
                 <%
                    String nombre= request.getParameter("emple");
                    if(nombre == null){
                 %>
                ...
                <p align="center"><div class="row" >
                    ...
                    ArrayList<tiquet> us = new ArrayList();
                    us=CRUD.getBuscartiquet(nombre);
                    for(tiquet o:us){%>
...
response.sendRedirect("/aut/cerrasesion");}
%>